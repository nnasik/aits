<div class="card card-outline card-primary collapsed-card">
    ...
    <div class="card-body" style="box-sizing: border-box; display: none;">
        ...
        <div class="timeline timeline-inverse">
            ...
            <?php $__currentLoopData = $job_request->histories->reverse(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <!-- timeline item -->
            <div>
                <div>
                    <img src="" alt="">
    ...
    <!-- /.card-body -->
</div><?php /**PATH D:\xampp\htdocs\aits\resources\views/template/history.blade.php ENDPATH**/ ?>