...
<head>
    ...
    <script>
        const trainingId = <?php echo e($training-> id); ?>;
    </script>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php if($trainee->pivot->photo): ?>
                        <img src="<?php echo e(asset('storage/'.$trainee->pivot->photo)); ?>" alt="Photo" height="50">
                        <?php else: ?>
                        <form action="<?php echo e(route('training.trainee.photo', [$training->id, $trainee->id])); ?>"
                    ...
                    <td>
                        ...
                        <button class="btn btn-sm btn-success"
                            onclick="openSignatureModal(<?php echo e($trainee->pivot->id); ?>, '<?php echo e($trainee->name); ?>')">
                            Add Sign
                        </button>
                        <?php endif; ?>
                    </td>
...
</html><?php /**PATH D:\xampp\htdocs\aits\resources\views/public/training.blade.php ENDPATH**/ ?>