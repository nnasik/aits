...
<div class="modal fade" id="quotationModal" tabindex="-1" aria-labelledby="quotationModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false" data-bs-focus="false">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <form id="quotationForm" autocomplete="off" method="POST" action="<?php echo e(route('quotation.store')); ?>">
        <?php echo csrf_field(); ?>
          ...
          <div class="row g-3">
            ...
            <div class="col-md-4">
              <div class="input-group">
                ...
                <input id="q_reference" type="text" class="form-control" value="<?php echo e($next_quotation_ref); ?>" name="reference" readonly/>
              </div>
            </div>
                  ...
                  <ul class="dropdown-menu p-2 w-100" aria-labelledby="companyDropdown" style="max-height:220px;overflow-y:auto;">
                    ...
                    <li>
                      <a class="dropdown-item company-item" href="#" 
                         ...
                         data-phone="<?php echo e($company->phone); ?>"
                         data-email="<?php echo e($company->email); ?>"
                         data-address="<?php echo e($company->address); ?>"
                         data-quote_for="<?php echo e($company->quote_for); ?>">
...
<?php /**PATH D:\xampp\htdocs\aits\resources\views/quotations/modals/new_quotation.blade.php ENDPATH**/ ?>