  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="companyNameForm" action="<?php echo e(route('trainee-requests.updateCompanyName')); ?>" method="POST">
          <?php echo csrf_field(); ?>
...
</script><?php /**PATH D:\xampp\htdocs\aits\resources\views/training_request/modals/change_company.blade.php ENDPATH**/ ?>