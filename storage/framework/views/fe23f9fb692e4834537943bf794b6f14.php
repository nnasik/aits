      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" name="qty" min="1" placeholder="Course name in certificate">
          </div>
          ...
          <!-- Scheduled Date -->
          <div class="input-group mb-3">
            <span class="input-group-text">Requesting Date</span>
            <input type="date" class="form-control" name="scheduled_date" placeholder="Scheduled Date">
          </div>

          <!-- Shceduled Time -->
          <div class="input-group mb-3">
            <span class="input-group-text">Requesting Time</span>
