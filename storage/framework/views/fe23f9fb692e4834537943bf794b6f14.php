...
<div class="modal fade" id="addRow" tabindex="-1" aria-labelledby="addRowLabel" aria-hidden="true">
  <form action="<?php echo e(route('trainingrequest.store')); ?>" method="post">
    <?php echo csrf_field(); ?>
    <input type="hidden" name="work_order_id" value="<?php echo e($job_request->id); ?>">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" name="company_name_in_certificate" placeholder="Company name in certificate" required value="<?php echo e($job_request->company_name_in_work_order); ?>">
          </div>
          ...
          <div class="input-group mb-3">
            ...
            <select class="form-control" id="trainingMode" name="training_mode">
              <option value="Certification" <?php if($job_request->training_mode=='Certification'): ?> selected <?php endif; ?>>Certification</option>
              <option value="In-Class" <?php if($job_request->training_mode=='In-Class'): ?> selected <?php endif; ?>>In-Class</option>
              <option value="Online" <?php if($job_request->training_mode=='Online'): ?> selected <?php endif; ?>>Online</option>
              <option value="On-Site" <?php if($job_request->training_mode=='On-Site'): ?> selected <?php endif; ?>>On-Site</option>
            </select>
...
<?php /**PATH D:\xampp\htdocs\aits\resources\views/job_request/modals/new_training.blade.php ENDPATH**/ ?>