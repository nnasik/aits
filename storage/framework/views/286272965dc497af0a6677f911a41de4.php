  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo e(route('training-requests.updateDl')); ?>" method="POST" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
...
</script><?php /**PATH D:\xampp\htdocs\aits\resources\views/training_request/modals/driving_license.blade.php ENDPATH**/ ?>