...
<div class="modal fade" id="createTraineeModal" tabindex="-1" aria-labelledby="createTraineeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form method="POST" action="<?php echo e(route('trainee.store')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="modal-body row g-3">
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="company_name_in_certificate" value="<?php echo e($training->company_name_in_certificate); ?>">
          </div>

          <div class="col-md-6">
            <label class="form-label">Course Name</label>
            <input type="text" class="form-control" name="course_name_in_certificate" value="<?php echo e($training->course_title_in_certificate); ?>">
          </div>
          ...
          <div class="col-md-6">
            ...
            <input type="date" class="form-control" name="date" value="<?php echo e($training->scheduled_date); ?>">
          </div>
...
</div><?php /**PATH D:\xampp\htdocs\aits\resources\views/job/modals/add_trainee.blade.php ENDPATH**/ ?>