...
<div class="app-content">
  ...
  <div class="container-fluid">
    ...
    <?php echo $__env->make('certificate.index.counts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <!--begin::Row-->
    <div class="row">
      <div class="col-6">
    ...
    <?php echo $__env->make('certificate.index.table', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <!--end::Row-->
    <!--end::Container-->
  </div>
  <!--end::App Content-->
