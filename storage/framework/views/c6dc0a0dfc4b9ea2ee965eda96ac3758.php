...
<div class="container my-4">
    ...
    <h4 class="mb-3">AITS Job Report generated by <?php echo e(auth::user()->name); ?></h4>
...
<div class="card mb-3">
    <div class="card-body">
        <div class="d-flex flex-wrap gap-2">
            ...
            <select id="filter_sales" class="form-select w-auto">
                ...
                <?php $__currentLoopData = $workOrders->pluck('sales.name')->unique()->filter(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <table id="reportTable" class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo e($wo->sales->name); ?></td>
...
<?php /**PATH D:\xampp\htdocs\aits\resources\views/reports/job_accounts.blade.php ENDPATH**/ ?>