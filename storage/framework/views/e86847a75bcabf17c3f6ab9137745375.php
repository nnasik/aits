...
<div class="modal fade" id="newRequestModal" tabindex="-1" aria-labelledby="newRequestModalLabel" aria-hidden="true">
  <form action="<?php echo e(route('jobrequest.store')); ?>" method="post">
    <?php echo csrf_field(); ?>
...
</div><?php /**PATH D:\xampp\htdocs\aits\resources\views/job_request/modals/new_request.blade.php ENDPATH**/ ?>