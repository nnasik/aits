...
<div class="modal fade" id="duplicateTraining" tabindex="-1" aria-labelledby="duplicateTrainingLabel" aria-hidden="true">
  <form action="<?php echo e(route('trainingrequests.duplicate')); ?>" method="POST">
    <?php echo csrf_field(); ?>
    <!-- Hidden Fields -->
        ...
        <div class="modal-body">
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" name="company_name_in_certificate"
                   value="<?php echo e($job_request->company_name_in_work_order); ?>" placeholder="Company name in certificate" required>
          </div>
