...
<div class="modal fade" id="editCertificateTitle" tabindex="-1" aria-labelledby="editCertificateTitleLabel"
    ...
    <div class="modal-dialog">
        <form id="editCertificateTitleForm" action="<?php echo e(route('trainee.updateCertificateTitle')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php /**PATH D:\xampp\htdocs\aits\resources\views/training_request/modals/certificate_for.blade.php ENDPATH**/ ?>