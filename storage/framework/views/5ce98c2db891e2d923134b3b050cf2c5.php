...
<div class="modal fade" id="jobStatusModal" tabindex="-1" aria-labelledby="jobStatusModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <form method="POST" action="<?php echo e(route('job.updateJobStatus')); ?>">
      <?php echo csrf_field(); ?>
...
<?php /**PATH D:\xampp\htdocs\aits\resources\views/job/modals/change_job_status.blade.php ENDPATH**/ ?>