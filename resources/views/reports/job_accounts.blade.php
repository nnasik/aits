...
<div class="container my-4">
    ...
    <h4 class="mb-3">AITS Job Report generated by {{auth::user()->name}}</h4>
...
<div class="card mb-3">
    <div class="card-body">
        <div class="d-flex flex-wrap gap-2">
            ...
            <!-- Sales Filter -->
            <select id="filter_sales" class="form-select w-auto">
                <option value="">Sales (All)</option>
                @foreach($workOrders->pluck('sales.name')->unique()->filter() as $s)
