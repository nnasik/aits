                    ...
                    <div class="card bg-light d-flex flex-fill">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-5 text-center">
                                    @if($user && $user->user_dp && file_exists(storage_path('app/public/user_dp/' . $user->user_dp)))

                                        <img class="rounded-circle me-3 " 
                                            src="{{ asset('storage/user_dp/' . $user->user_dp) }}" 
                        ...
                        <div class="card-footer">
                            <div class="text-right">
                                ...
                                <a href="{{route('users.view',$user->id)}}" class="btn btn-sm btn-primary">
