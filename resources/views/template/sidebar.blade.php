<ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation" aria-label="Main navigation"
  ...
  @role('Manager')
  <li class="nav-item">
    <a href="{{route('dashbaord.index')}}" class="nav-link">
  ...
  <li class="nav-item  menu-open">
    ...
    <ul class="nav nav-treeview">
      ...
      <li class="nav-item">
        <a href="{{route('jobrequest.index')}}" class="nav-link">
          <div>  </div>
  ...
  <li class="nav-item menu-open">
    ...
    <ul class="nav nav-treeview">
      ...
      <li class="nav-item">
        <a href="{{route('training.nojob')}}" class="nav-link">
          <div>  </div>
  ...
  <li class="nav-item menu-open">
    ...
    <ul class="nav nav-treeview">
      ...
      <li class="nav-item">
        <a href="{{route('report.jobsAccounts')}}" class="nav-link">
          <div>  </div>
