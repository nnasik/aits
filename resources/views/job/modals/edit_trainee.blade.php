...
<div class="modal fade" id="editTraineeModal" tabindex="-1" aria-labelledby="editTraineeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form id="editTraineeForm" method="POST" action="{{ route('trainee.update') }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="modal-body row g-3">
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control bg-light" id="company_name_in_certificate">
          </div>

          <div class="col-md-6">
            <label class="form-label">Course Name</label>
            <input type="text" class="form-control bg-light" id="course_name_in_certificate">
          </div>
