    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-end">
         <li class="breadcrumb-item">Training ({{$training->id}})</li>
          @if($job)
          <li class="breadcrumb-item active" aria-current="page"><a href="{{route('job.show', $job->id)}}">Job - {{$job->id}}</a></li>
          @endif
...
<div class="app-content">
  ...
  @include('job.modals.add_signature')
  @endsection()