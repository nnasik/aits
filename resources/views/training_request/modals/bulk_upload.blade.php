  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('training-requests.bulkUpload')}}" method="POST" enctype="multipart/form-data" id="bulkUploadForm">
          @csrf
          ...
          <input type="hidden" id="bulkMaxFiles" value="{{ $training_request->quantity ?? 5 }}"> <!-- Default to 5 if null -->
