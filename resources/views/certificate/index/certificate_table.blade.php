                        ...
                        <td>
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-outline-primary" target="_blank" href="{{route('certificate.pdf.v_1_2',$certificate->id)}}">V 1.1</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-outline-primary" target="_blank" href="{{route('certificate.pdf.v_2_2',$certificate->id)}}">V 2.2</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('scan.pdf.v_1',$certificate->id)}}" target="_blank" class="btn btn-outline-primary">V1</a>
