          ...
          <form method="POST" action="{{ route('change.user.settings') }}">
            ...
            <div class="btn-group mb-2" role="group" aria-label="Background selector">
              ...
              <input type="radio" class="btn-check" name="value" id="bg_white" value="0" onchange="this.form.submit()"
                {{ (isset($user_settings['certificate_bg']) && $user_settings['certificate_bg']==0) ? 'checked' : '' }}>
              <label class="btn btn-outline-primary" for="bg_white">White</label>

              <input type="radio" class="btn-check" name="value" id="bg_v1" value="1" onchange="this.form.submit()" {{
                (isset($user_settings['certificate_bg']) && $user_settings['certificate_bg']==1) ? 'checked' : '' }}>
              <label class="btn btn-outline-primary" for="bg_v1">V1</label>

              <input type="radio" class="btn-check" name="value" id="bg_v2" value="2" onchange="this.form.submit()" {{
                (isset($user_settings['certificate_bg']) && $user_settings['certificate_bg']==2) ? 'checked' : '' }}>
              <label class="btn btn-outline-primary" for="bg_v2">V2</label>

              <input type="radio" class="btn-check" name="value" id="bg_v3" value="3" onchange="this.form.submit()" {{
                (isset($user_settings['certificate_bg']) && $user_settings['certificate_bg']==3) ? 'checked' : '' }}>
          ...
          <form method="POST" action="{{ route('change.user.settings') }}">
            ...
            <div class="btn-group mb-2" role="group" aria-label="Signature options">
              ...
              <input type="radio" class="btn-check" name="value" id="signature_empty" value="0" autocomplete="off"
                onchange="this.form.submit()" {{ (isset($user_settings['certificate_signature_option']) &&
          ...
          <form method="POST" action="{{ route('change.user.settings') }}">
            ...
            <div class="btn-group mb-2" role="group" aria-label="Stamp options">
              ...
              <input type="radio" class="btn-check" name="value" id="stamp_off" value="0" autocomplete="off"
                onchange="this.form.submit()" {{ (isset($user_settings['certificate_stamp_option']) &&
          ...
          <form method="POST" action="{{ route('change.user.settings') }}">
            ...
            <div class="btn-group mb-2" role="group" aria-label="ID Card options">
              ...
              <input type="radio" class="btn-check" name="value" id="idcard_v1" value="1" autocomplete="off"
                onchange="this.form.submit()" {{ (isset($user_settings['certificate_idcard_option']) &&
